   <!-- Tab Content !-->
    <table class="optiontable form-table">
        ...
        <tr valign="top">
            <th scope="row">
                <label for="<?php echo live_sales_notifications_set_field('enable_single_product') ?>"><?php esc_html_e('Run single product', 'live-sales-notifications') ?></label>
            </th>
            <td>
                <div class="mbui toggle checkbox">
                    <input id="<?php echo live_sales_notifications_set_field('enable_single_product') ?>"
                           type="checkbox" <?php checked(live_sales_notifications_get_field('enable_single_product'), 1) ?>
                           tabindex="0" class="hidden" value="1"
                           name="<?php echo live_sales_notifications_set_field('enable_single_product') ?>"/>
                    <label></label>
                </div>
        ...
        <tr valign="top">
            <th scope="row">
                <label for="<?php echo live_sales_notifications_set_field('notification_product_show_type') ?>"><?php esc_html_e('Notification show', 'live-sales-notifications') ?></label>
            </th>
            <td>

                <select name="<?php echo live_sales_notifications_set_field('notification_product_show_type') ?>"
        ...
        <tr valign="top" class="only_current_product hidden">
            <th scope="row">
                <label for="<?php echo live_sales_notifications_set_field('show_variation') ?>"><?php esc_html_e('Show variation', 'live-sales-notifications') ?></label>
            </th>
            <td>
                <div class="mbui toggle checkbox">
                    <input id="<?php echo live_sales_notifications_set_field('show_variation') ?>"
                           type="checkbox" <?php checked(live_sales_notifications_get_field('show_variation'), 1) ?>
                           tabindex="0" class="hidden" value="1"
                           name="<?php echo live_sales_notifications_set_field('show_variation') ?>"/>
                    <label></label>
                </div>
